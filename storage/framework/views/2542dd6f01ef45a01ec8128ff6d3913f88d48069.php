...
<head>
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav me-auto">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="lihat" href="#" onclick="lihatpustaka()">Category</a>
                  </li>
                  <li class="nav-item">
    ...
    <div id="tabel" style="background-image: url(<?php echo e(asset('storage/BG.jpg')); ?>);padding: 8px;">
...
</html><?php /**PATH C:\xampp\htdocs\ProjectWeb\resources\views/home.blade.php ENDPATH**/ ?>