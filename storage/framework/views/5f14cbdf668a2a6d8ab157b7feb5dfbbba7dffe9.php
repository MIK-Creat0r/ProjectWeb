    ...
    <div id="article">
        ...
        <div id="Galeri" style="text-align: center; color: white;">
            ...
            <figure id="foto">
                ...
                <img width="300" height="400" src="<?php echo e(asset('storage/Bakemonogatari_Manga_1.jpg')); ?>" class="rounded-3">
                <img width="300" height="400" src="<?php echo e(asset('storage/Bakemonogatari_Manga_2.jpg')); ?>" class="rounded-3">
                <img width="300" height="400" src="<?php echo e(asset('storage/Bakemonogatari_Manga_5.jpg')); ?>" class="rounded-3">
            </figure>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\ProjectWeb\ProjectWeb\resources\views/konten.blade.php ENDPATH**/ ?>