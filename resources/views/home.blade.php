...
<body onload="konten()">
        ...
        <div class="container-fluid">
            ...
            <div class="dropdown dropstart">
                <button type="button" class="btn" data-bs-toggle="dropdown">
                    <img src="{{ asset('storage/logo.png') }}" alt="Avatar Logo" style="width:40px;" class="rounded-pill">
                </button>
    ...
    <div id="tabel" style="background-image: url({{ asset('storage/BG.jpg') }}); background-size: cover; background-position: center; padding: 8px;">
